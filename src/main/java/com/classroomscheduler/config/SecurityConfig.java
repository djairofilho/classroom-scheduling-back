    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/reservations/por-espaco").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/reservas/lote").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/reservations/bulk").hasRole("ADMIN")
